...
dockutil --add /Applications/Slack.app --replacing Slack --position 6
# dockutil --add /Applications/iTerm.app --replacing iTerm --position 7
dockutil --add /Applications/Ghostty.app --replacing Ghostty --position 7
dockutil --add /Applications/Visual\ Studio\ Code.app --replacing 'Visual Studio Code' --position 8
